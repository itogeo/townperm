...
CREATE TABLE IF NOT EXISTS permits (
  ...
  owner_name TEXT, owner_phone TEXT, owner_email TEXT, owner_address TEXT, owner_city TEXT, owner_state TEXT, owner_zip TEXT,
  lot TEXT, block TEXT, subdivision TEXT, land_area TEXT,
  builder_name TEXT, builder_phone TEXT, builder_email TEXT, builder_license TEXT,
  builder_address TEXT, builder_city TEXT, builder_state TEXT, builder_zip TEXT,
  description TEXT, work_type TEXT, valuation REAL DEFAULT 0, square_footage INTEGER,
  construction_start TEXT, corner_pins TEXT, after_the_fact INTEGER DEFAULT 0,
  project_name TEXT, developer_name TEXT, developer_phone TEXT,
  variance_regulation TEXT, variance_hardship TEXT, variance_public_interest TEXT,
  floodplain_permit_num TEXT, elevation_cert TEXT, foundation_type TEXT,
  building_height_residential TEXT, building_height_commercial TEXT, building_height_accessory TEXT,
  connection_type TEXT, structure_type TEXT, connect_date TEXT,
  line_size TEXT, line_length TEXT, sewer_grade TEXT, contractor_insurance TEXT,
